...
import avarovideo from "../Cards/el-avaro.mp4";
import clasificadorvideo from "../Cards/el-clasificador.mp4";
import guachevideo from "../Cards/el-guache.mp4";
import guettovideo from "../Cards/el-guetto.mp4";
import monocultivovideo from "../Cards/el-monocultivo.mp4";
import sancochovideo from "../Cards/el-sancocho.mp4";
import agropolisvideo from "../Cards/la-agropolis.mp4";
import copetonavideo from "../Cards/la-copetona.mp4";
import maculavideo from "../Cards/la-macula.mp4";
import bayetillavideo from "../Cards/la-bayetilla.mp4";
import cocinavideo from "../Cards/la-cocina.mp4";
import ahogadxvideo from "../Cards/lx-ahogadx.mp4";
import avaroset from "../Downloadables/el-avaro.zip";
import clasificadorset from "../Downloadables/el-clasificador.zip";
import guacheset from "../Downloadables/el-guache.zip";
import guettoset from "../Downloadables/el-guetto.zip";
import monocultivoset from "../Downloadables/el-monocultivo.zip";
import sancochoset from "../Downloadables/el-sancocho.zip";
import agropolisset from "../Downloadables/la-agropolis.zip";
import copetonaset from "../Downloadables/la-copetona.zip";
import maculaset from "../Downloadables/la-macula.zip";
import bayetillaset from "../Downloadables/la-bayetilla.zip";
import cocinaset from "../Downloadables/la-cocina.zip";
import ahogadxset from "../Downloadables/lx-ahogadx.zip";
