  ...
  return (
    <Grid className={"intro"} stackable columns={2}>
      ...
      <Grid.Column className={"introdescription"} textAlign="justified">
        <p>
          El presente de la ciudad está marcado profundamente por la experiencia
          de las cuarentenas, la crisis ambiental, social y económica agudizada
          por la COVID-19, pero también está formado por la solidaridad, los
          nuevos encuentros y las vidas salvadas. Eso que llamamos “normalidad”
          y que podríamos añorar es un escenario insostenible para los seres
          humanos y el planeta.
          <br></br>
          <br></br>
          Es el momento de preguntarnos qué queremos guardar de esta experiencia
          como aprendizaje colectivo. ¿Qué narrativas sobre el presente son
          esenciales para los bogotanos del futuro?
          <br></br>
          <br></br>
