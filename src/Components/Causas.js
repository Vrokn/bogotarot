...
const Causas = () => (
  <div className={"causascards"}>
    <div className={"causacard"} id="biodiversidad">
      {/*  Causa 1 */}
      <div className="cardtitle">
        <div className="cardtitlecontainer">
          ...
          <div className={"videocausa"}>video</div>
        </div>
      </div>
      <div className="carddescription">
        <div className="carddescriptioncontainer">
          ...
          <div className={"causadescription"}>
            ...
            <p>
              Bogotá y su entorno son territorios ricos y diversos, tanto en
              poblaciones humanas como de otras especies. Esta biodiversidad es
              un gran banco de herramientas frente a la incertidumbre que ha
              provocado la pandemia de COVID-19, sobre nuestro trabajo, estudio,
              contacto con familia y amigos, y con la naturaleza. La diversidad
              también se expresa en el derecho a la ciudad que permite que todos
              los que viven en ella puedan usufructuar de manera equitativa el
              espacio colectivo y allí realizarse, a pesar de la incertidumbre.
            </p>
          </div>
      ...
      <div className="cardactivities"></div>
